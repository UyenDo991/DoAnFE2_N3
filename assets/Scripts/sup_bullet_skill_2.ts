...
@ccclass('BossSkillProjectile')
export class BossSkillProjectile extends Component {
    ...
    @property
    lifetime: number = 3;
    // Bán kính phát hiện va chạm với player
    @property
    detectRadius: number = 1.0; 
